# Issue 112: OCBC account ingestion

## Objective
Build a parser for OCBC bank account transaction history exported as `.csv` . The fixture file <> contains real transaction data from a OCBC. 
