...
| S5 | (next) Candidate admission tightening for explicit topic entities | Reduce weak Amazon-adjacent chunks | Aggregate non-regression + better target query ranking | Pending | Test as single isolated diff |
