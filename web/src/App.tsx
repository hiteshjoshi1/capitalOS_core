            ...
            <div className="card">
              ...
              <div className="kpi">
                ...
                {hasRiskDistribution ? (
                  ...
                  <div className="riskNoData">
                    No holdings concentration data for this month or net worth is not positive.
                  </div>
                )}
                {!riskTopN.hasFullSelection && riskTopN.hasData ? (
                  <div className="riskHelperText">
